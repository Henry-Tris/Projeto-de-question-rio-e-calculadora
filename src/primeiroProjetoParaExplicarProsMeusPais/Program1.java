...
public class Program1 {
	...
	public static void main(String[] args) {
		...
		// STRINGS PARA MUDAR A COR DE TEXTO
		String azul = "\u001B[34m";
		String vermelho = "\u001B[31m";
		String verde = "\u001B[32m";
		String roxo = "\u001B[35m";
		...
		// CALCULO PARA SABER O PESO IDEAL
		if (IMC < 18.5 || IMC >= 25) {
			...
			if (IMC < 18.5) {
				System.out.printf("Você precisa ganhar aproximadamente " + azul + "%.2f kg%n" + reset,
						(pesoMin - peso));
			} else if (IMC >= 25) {
				System.out.printf("Você precisa perder aproximadamente " + azul + "%.2f kg%n" + reset,
						(peso - pesoMax));
			}
		}
		...
		// VALIDAÇÃO DA RESPOSTA DA CALCULADORA
